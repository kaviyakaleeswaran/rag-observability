...
def extract_citations(answer_text):
    ...
    * resnet_38
    ...
    Only valid project chunk-ID formats are accepted.
    """
    ...
    citation_section = answer_text.split(
        "CITATIONS:",
        1
    )[1]

    lines = citation_section.strip().splitlines()
    ...
    for line in lines:
        ...
        # Ignore obvious non-citation text
        if line.upper() == "CITATIONS:":
            continue

        # Our chunk IDs have the form:
        #
        # resnet_38
        # faster_rcnn_0
        # unet_15
